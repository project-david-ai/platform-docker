...
#
# VERSION: Sovereign Forge + Silent Initialization
#
...
class Orchestrator:
    ...
    # SILENCE CHANGE: Removed API_KEY and ADMIN_API_KEY from summary keys
    _SUMMARY_KEYS = [
        "DATABASE_URL",
        "SPECIAL_DB_URL",
        "SHARED_PATH",
    ...
    def _generate_dot_env_file(self):
        ...
        # SILENCE CHANGE: Commented out the automatic summary print on first run
